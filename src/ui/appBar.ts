...
const GITHUB_URL = 'https://github.com/lumpsoid/SiralimUltimateSaver';

// GitHub mark (MIT-licensed Octicon), inlined to avoid an icon dependency.
const GITHUB_ICON =
...
export function createAppBar(): HTMLElement
{
  const link = el('a', {
    class: 'appbar-link',
    href: GITHUB_URL,
